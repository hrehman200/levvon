...
class Gst
{
    ...
    function genHTML($tax_summary = [], $product_tax = 0) {
        ...
        if (!empty($tax_summary)) {
            ...
            $html .= '<div class="table-responsive"><table class="table table-bordered table-striped print-table order-table table-condensed"><thead><tr><th>' . lang('name') . '</th><th>' . lang('code') . '</th><th>' . lang('qty') . '</th><th>' . lang('tax_excl') . '</th><th>' . lang('tax_amt') . '</th></tr></td><tbody>';
