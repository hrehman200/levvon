...
<ul id="myTab" class="nav nav-tabs no-print">
    ...
    <li class="notesTab"><a href="#notes-con" class="tab-grey"><?= lang('Notes') ?><span class="badge spUnreadNoteCount">0</span></a></li>
</ul>
...
<div class="tab-content">
                                ...
                                <tr class="primary">
                                    ...
                                    <th style="width:85px;">
                                        <a class="tip" style="color:white;" title='<?= lang("add_note") ?>'
                                           href="<?= admin_url('customers/edit_note/' . $user_id . "/" . $page) ?>"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.tab-grey').on('shown.bs.tab', function (e) {
