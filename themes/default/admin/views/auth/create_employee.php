...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i>Create Employee</h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <p class="introtext">Create Employee</p>

                <?php $attrib = array('class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form');
                echo admin_form_open("auth/create_employee", $attrib);
                ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-5">
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div class="form-group">
                                ...
                                foreach ($regions as $region) {
                                    $gp[$region['id']] = $region['name'];
                                }
                                echo form_dropdown('region', $gp, (isset($_POST['region']) ? $_POST['region'] : ''), 'id="region" required="required" class="form-control select" style="width:100%;"');
                                ?>
                            </div>
                ...
                <p><?php echo form_submit('add_user', 'Add Employee', 'class="btn btn-primary"'); ?></p>
