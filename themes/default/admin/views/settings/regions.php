...
<script>
    $(document).ready(function () {
        $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getRegions') ?>',
...
<?= admin_form_open('system_settings/region_actions', 'id="action-form"') ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i>Regions</h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('system_settings/add_region'); ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> Add Region
                            </a>
                        </li>
                        <!--<li>
                            <a href="<?php /*echo admin_url('system_settings/import_regions'); */?>" data-toggle="modal" data-target="#myModal">
                        ...
                        <li>
                            <a href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> Delete Regions
                            </a>
                        </li>
                    </ul>
                </li>
